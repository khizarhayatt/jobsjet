            ...
            <div class="row">
                                    ...
                                    <div class=" col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="title" name="name"
                                                placeholder="Enter Organization Title" value="{{ old('name') }}">
                                        </div>
                                        <div class="form-group">
                ...
                <div class="  col-sm-12 col-md-8 col-lg-8">
                    <div class="card">
                        <div class="card-header justify-content-between">
                            <h4>Organizations</h4>
                            <form action="{{ route('organization.index') }}" class="card-header-form">
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                ...
                                <table id="industryTable" class="table table-striped table-md">
                                    <tbody>
                                        <tr>
                                            <th>#</th>
                                            <th>Title</th>
                                        ...
                                        @forelse ($organizations as $key => $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="buttons">
                                                        ...
                                                        <form method="post" class="d-inline-block"
                                                            action="{{ route('organization.destroy', $item->id) }}">
                                                            @method('delete')
                                                            @csrf
                                                            <button type="submit"
                                                                class="deleteOrganization d-inline-block btn btn-icon btn-sm btn-danger">
