                                    ...
                                    <div class="  col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="title" name="name"
                                                placeholder="Enter Profession Title" value="{{ $profession->name }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="description">Profession Description</label>
                                            <textarea name="description" class="form-control" id="" cols="50" rows="50">{{ $profession->description }}</textarea>
                                        </div>
                                    </div>
